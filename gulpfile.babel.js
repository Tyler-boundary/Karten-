...
const DEST_FOLDER = 'public/wp-content/themes/boundary';
...
gulp.task('static', () => {
  return gulp.src('src/**/*.{html,php,twig,jpg,jpeg,png,gif,webp,mp4,svg,ico,eot,ttf,woff,woff2,otf}').pipe(gulp.dest(DEST_FOLDER));
});
...
gulp.task('serve', ['styles', 'scripts', 'static'], () => {
  ...
  gulp.watch(['src/**/*.{html,php,twig,jpg,jpeg,png,gif,webp,mp4,svg,ico,eot,ttf,woff,woff2,otf}'], ['static']).on('change', (event) => {
    browserSync.reload();
